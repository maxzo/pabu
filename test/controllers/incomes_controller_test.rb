...
class IncomesControllerTest < ActionController::TestCase
  ...
  test "should create income" do
    assert_difference('Income.count') do
      post :create, income: { amount: @income.amount, date: @income.date, description: @income.description }
    end
  ...
  test "should update income" do
    patch :update, id: @income, income: { amount: @income.amount, date: @income.date, description: @income.description }
    assert_redirected_to income_path(assigns(:income))
  end
